...
// ✅ CORRECTION : generateMetadata doit aussi gérer params en tant que Promise
export async function generateMetadata({
    ...
    return {
        title: currentProduct?.name || 'Product not found',
        ...
        <div className="flex flex-col gap-4 lg:flex-row md:gap-12 mt-12">
            ...
            <div className="w-full lg:w-7/12 flex flex-col gap-4">
                ...
                <p className="text-gray-500 text-xs">
                    ...
                    <span className="underline hover:text-black">Privacy Policy</span>. You
                    authorise us to charge your selected payment method for the total amount
                    shown. All sales are subject to our return and{' '}
