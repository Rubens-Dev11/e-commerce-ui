                        ...
                        cart.map((item) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-10 h-10 rounded-full bg-red-400 hover:bg-red-600 transition-all duration-300 text-white flex items-center justify-center cursor-pointer"
                                >
